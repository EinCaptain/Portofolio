...
function SmartMediaDisplay({ src, title, alt }: { src: string; title: string; alt?: string }) {
  ...
  if (hasError) {
    return (
      <div className="w-full aspect-square flex flex-col items-center justify-center p-3 text-center rounded-xl border border-dashed border-slate-300 bg-white/50 space-y-1">
        <div className="w-8 h-8 rounded-full bg-slate-200 border border-slate-300 flex items-center justify-center text-slate-600 shadow-sm">
        ...
        <p className="text-[10px] text-slate-700 font-mono bg-white/80 px-2 py-0.5 rounded-full border border-slate-300 truncate max-w-full">
          {src}
        </p>
      </div>
    );
...
function InstagramAvatar({ username, displayName, avatarImg }: { username?: string; displayName?: string; avatarImg?: string }) {
  ...
  return (
    <div className="w-full h-full bg-slate-900 flex items-center justify-center text-white font-black text-xl uppercase">
      {username?.substring(0, 2) || 'IG'}
    </div>
  );
}
      ...
      >
        ...
        {currentView === 'main' && (
          <div className="space-y-14">
            <section 
              id="home" 
              className="relative overflow-hidden flex flex-col justify-between p-6 sm:p-10 md:p-14 text-slate-900 mx-auto liquid-glass-3d"
              style={{
                width: '100%',
                maxWidth: '1500px',
                minHeight: '85vh',
            ...
            >
              {/* FOTO HERO PROFILE */}
              {!profileImgError && (
                <div className="absolute right-0 bottom-0 top-0 w-full md:w-1/2 pointer-events-none z-10 flex items-end justify-center md:justify-end pr-0 md:pr-8 overflow-hidden">
                  <img 
                    src="/profile.png" 
                    alt="Andhika Rievaldy" 
                    className="h-[75%] sm:h-[88%] md:h-[98%] max-h-full w-auto object-contain object-bottom drop-shadow-[0_20px_35px_rgba(15,23,42,0.18)]"
              ...
              <div className="flex items-center justify-between w-full relative z-20">
                <div 
                  className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[12px] md:text-[14px] text-slate-800 bg-white/80 backdrop-blur-md border border-white/90 shadow-sm font-bold"
                >
              ...
              <div className="my-auto pt-8 pb-12 relative z-20 max-w-[620px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-8 text-[15px] md:text-[16px] text-slate-700 font-medium">
                  ...
                  >
                    <svg width="18" height="18" style={{ minWidth: '18px', minHeight: '18px' }} className="w-4 h-4 text-slate-800 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div 
                    className="flex items-center gap-2.5 p-3.5 rounded-2xl bg-white/70 backdrop-blur-md border border-white/90 select-none shadow-sm"
                  >
                    <svg width="18" height="18" style={{ minWidth: '18px', minHeight: '18px' }} className="w-4 h-4 text-slate-800 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex justify-center relative z-20 pt-4">
                <div 
                  className="rounded-full p-1.5 flex items-center gap-1 text-[12px] md:text-[14px] bg-white/80 backdrop-blur-lg border border-white shadow-sm"
                >
                  <a href="#home" className="px-5 py-2 rounded-full bg-slate-900 text-white font-bold shadow-sm">Home</a>
                  <a href="#about" className="px-4 py-2 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors">About</a>
                  <a href="#tools" className="px-4 py-2 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors">Software</a>
                  <a href="#services" className="px-4 py-2 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors">Services</a>
                  <a href="#work" className="px-4 py-2 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors">Work</a>
                  <a href="#contact" className="px-4 py-2 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors">Links</a>
                </div>
              </div>
            ...
            <section 
              id="about" 
              className="p-8 md:p-12 text-slate-900 mx-auto liquid-glass-3d overflow-hidden"
              style={{
                width: '100%',
                maxWidth: '1500px',
              }}
            >
              <div className="grid md:grid-cols-12 gap-8 items-center relative z-10">
                <div className="md:col-span-7 space-y-4">
                  <div>
                    <span className="text-[12px] md:text-[14px] font-extrabold text-slate-700 tracking-wider uppercase block">About Me</span>
                  ...
                  <p 
                    className="text-[15px] md:text-[16px] font-normal text-slate-700 leading-relaxed text-justify"
                  >
                ...
                <div className="md:col-span-5 space-y-3">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-xl flex items-center justify-center text-slate-800 bg-white/90 shrink-0 border border-slate-200/80 shadow-xs">
            ...
            <section id="tools" className="space-y-6 mx-auto" style={{ width: '100%', maxWidth: '1500px' }}>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {[
                  ...
                  <div 
                    key={idx} 
                    className="p-6 transition-all duration-300 space-y-3 h-full flex flex-col justify-between liquid-glass-3d hover:scale-[1.015] overflow-hidden"
                  >
                    <div className="space-y-3 relative z-10">
                      <div className="flex items-center justify-between">
                        <div className="w-10 h-10 rounded-xl text-slate-800 bg-white/80 border border-white flex items-center justify-center shrink-0 shadow-xs">
                          {tool.icon}
                        </div>
            ...
            <section id="services" className="space-y-6 mx-auto" style={{ width: '100%', maxWidth: '1500px' }}>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {[
                  ...
                  <div 
                    key={idx} 
                    className="p-6 transition-all duration-300 space-y-4 h-full flex flex-col justify-between liquid-glass-3d hover:scale-[1.015] overflow-hidden"
                  >
                    <div className="space-y-3 relative z-10">
                      <div className="w-10 h-10 rounded-xl text-slate-800 bg-white/80 border border-white flex items-center justify-center shrink-0 shadow-xs">
                        {item.icon}
            ...
            <section id="work" className="space-y-6 mx-auto" style={{ width: '100%', maxWidth: '1500px' }}>
              ...
              <div className="grid md:grid-cols-2 gap-6" style={{ width: '100%' }}>
                {[
                  ...
                  <div 
                    key={idx} 
                    className="p-6 sm:p-8 transition-all duration-300 space-y-4 flex flex-col justify-between liquid-glass-3d hover:scale-[1.015] overflow-hidden"
                    style={{ width: '100%' }}
                  >
                    ...
                    <div className="pt-2 relative z-10">
                      <button 
                        type="button"
                        onClick={proj.action}
                        className="inline-flex items-center justify-center px-6 py-2.5 rounded-xl text-[12px] md:text-[14px] font-bold text-white bg-slate-900/90 hover:bg-slate-900 transition-all cursor-pointer shadow-sm backdrop-blur-sm"
                      >
            ...
            <footer 
              id="contact" 
              className="p-8 md:p-12 text-center space-y-6 text-slate-900 mx-auto liquid-glass-3d overflow-hidden"
              style={{
                width: '100%',
                maxWidth: '1500px'
              }}
          ...
          >
            <div className="relative z-10 flex items-center justify-between pb-3 border-b border-slate-900/10 shrink-0 mb-3">
              <div className="flex items-center gap-2">
                <span className="text-slate-800 font-extrabold text-[12px] md:text-[14px] uppercase tracking-wider">Credential Viewer</span>
                      ...
                      <div className="space-y-4 flex-1">
                        ...
                        <div className="space-y-1 text-[15px] md:text-[17px] font-normal text-slate-800">
                          ...
                          {activePreview.bio?.map((line, idx) => (
                            <p key={idx} className="leading-relaxed text-justify">{line}</p>
                          ))}
